...
////// Emissive:
                ...
                float3 node_2910 = lerp(_DarkCol_var.rgb,_LightCol_var.rgb,round(saturate(( saturate(dot(normalDirection,lightDirection)) > 0.5 ? (1.0-(1.0-2.0*(saturate(dot(normalDirection,lightDirection))-0.5))*(1.0-node_2588)) : (2.0*saturate(dot(normalDirection,lightDirection))*node_2588) ))));
                float3 emissive = node_2910;
